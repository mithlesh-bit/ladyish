  ...
  const steps = [
    {
      ...
      description: "Smart filtering & suggestions make it easy to find",
    ...
    },
    {
      ...
      title: "Add to bag",
      description: "Easily select the correct items & add them to the cart",
    ...
    },
    {
      ...
      title: "Confirmation",
      description: "We will confirm your payment & get back to you asap",
    ...
    },
    {
      ...
      description: "Have fun & enjoy your best quality products",
