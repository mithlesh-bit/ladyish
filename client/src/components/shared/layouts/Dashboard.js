  ...
  if (user?.role === "seller") {
    routes = [
      ...
      },
      {
        ...
        paths: [
          {
            name: "Add Corousel Image",
            path: "/dashboard/seller/corousel/get-corousel",
          },
          {
            name: "View Corousels",
            path: "/dashboard/seller/corousel/list-corousel",
          },
        ],
      },

      {
        name: "Custom Product Application",
        paths: [
          {
            name: "View Applications",
            path: "/dashboard/seller/custom-applications",
          },
        ],
      },
    ];
    ...
    <main className="h-screen w-screen">
      <section className="max-w-5xl mx-auto h-full flex flex-col gap-y-4 p-2">
        ...
        <footer className="border px-4 py-2 rounded flex justify-center items-center flex-row">
          <p className="text-xs">
            © {new Date().getFullYear()} Ladyish. All rights reserved.
          </p>
        </footer>
      </section>
    </main>
